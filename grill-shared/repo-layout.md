...
```
<project>/
├── AGENTS.md             Codex entry point (generated by derive-conventions)
├── CLAUDE.md             Claude Code entry point (same generated content)
...
│   ├── conventions/     derive-conventions            standards·dep/boundary rules·DoD·cmds (+ root AGENTS.md/CLAUDE.md)  DERIVE
...
`spec/`** — the closed-world rule governs `spec/` only; `AGENTS.md` and `CLAUDE.md` sit at the repo root.
