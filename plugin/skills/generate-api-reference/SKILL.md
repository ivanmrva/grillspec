...
Consumes: the API/event contracts — `07-solution/api/` (`API-` REST/RPC endpoints, `EVT-` events) + their request/response schemas (`DATA-` where referenced) + auth/authz (`SEC-`) + error models + versioning — read-only, never edits the spec.
