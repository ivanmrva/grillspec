...
|---|---|---|
| `capabilities.md` | per ML capability (id `ML-NNN`): the task (classify · extract · generate · rank · agentic) · inputs/outputs · the decision it drives · the human-in-loop point | id · task · I/O · decision · HITL |
...
| `data-needs.md` | training/feedback/label data the capability needs: source · labelling · volume · refresh/drift cadence (the data *class* itself lives in the data requirements) | source · labelling · volume · refresh |
