...
- **Explanation** (understanding-oriented) — the full narrative spec
  ...
  - **Implementation design** — consolidated from the per-module `09-solution/impl/*` internals + the per-task `design:` decisions, grouped by module / subsystem
