...
Consume the source by **stable ID** (`UC-`/`CMD-`/`NFR-`/…); every decision traces to the elements it satisfies. Respect bounded-context and layering boundaries — your output defines or specialises them.
