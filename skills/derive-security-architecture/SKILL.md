...
**Load `references/derive-engine.md` first and follow it.** This skill applies that method to **Security architecture** — authn/authz, encryption, secrets and identity.
