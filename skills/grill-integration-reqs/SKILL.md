...
**Load `references/grill-engine.md` first and follow it.** This skill applies that method to **Integration requirements** — the qualities/obligations of each external exchange, not the boundary roster itself.
