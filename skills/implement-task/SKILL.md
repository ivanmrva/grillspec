...
## Process
1. **Branch + open the Verification Record.** On `task/T-NNN-…`, generate the pre-implementation checklist — `python3 scripts/check_task_record.py spec --init T-NNN` — which materializes, from the task's frozen spec references, the obligation table you'll be held to. You see the bar before you write a line; you can't shrink it.
