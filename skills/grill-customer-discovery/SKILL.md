...
**Load `references/grill-engine.md` first and follow it.** This skill applies that method to **Customer & market discovery** — the segments, personas, and jobs-to-be-done.
