...
**Load `references/derive-engine.md` first and follow it.** This skill applies that method to **API & event contracts** — a machine-readable spec in the **latest stable OpenAPI**, an event spec in the **latest stable AsyncAPI**, their schemas and versioning.
