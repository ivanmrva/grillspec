...
**Load `references/grill-engine.md` first and follow it.** This skill applies that method to **Problem validation & discovery** — the problem worth solving and the riskiest bets behind it.
