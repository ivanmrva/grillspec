...
**Load `references/derive-engine.md` first and follow it.** This skill applies that method to **Test strategy** — verification AND active edge-case discovery, across two tiers.
