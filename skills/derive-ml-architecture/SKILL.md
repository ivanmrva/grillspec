...
**Load `references/derive-engine.md` first and follow it.** This skill applies that method to **ML system architecture** — serving, evaluation, data/feedback pipelines, monitoring, and guardrails for an ML capability.
