...
**Load `references/grill-engine.md` first and follow it.** This skill applies that method to **Market & competitive landscape** — who else solves this, why we win, and how big it is.
