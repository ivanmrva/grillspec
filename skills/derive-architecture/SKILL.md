...
**Load `references/derive-engine.md` first and follow it.** This skill applies that method to **Solution architecture** — style, C4 decomposition, stack, contexts→services, and cross-cutting concerns.
