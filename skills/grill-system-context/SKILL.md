...
**Load `references/grill-engine.md` first and follow it.** This skill applies that method to **System context & scope** — the system as one black box and everything at its boundary, drawn as the Level-1 (System Context) view.
