...
# Directories owned by derive-* skills (regenerate-only) + generated agent instructions.
DERIVED_PREFIXES = [
    "spec/05-functional-spec/",
    "spec/09-solution/",                 # arch, data, api, security, infra-ops, observability, test, ml
