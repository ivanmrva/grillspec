...
**Load `references/derive-engine.md` first and follow it.** This skill applies that method to **Data architecture** — schema, storage, consistency, partitioning and migration.
